package com.appspiriment.composeutils.components.containers.swipeactionbox
...
import com.appspiriment.composeutils.components.containers.swipeactionbox.ActionFinder
import com.appspiriment.composeutils.components.containers.swipeactionbox.SwipeAction
import com.appspiriment.composeutils.components.containers.swipeactionbox.SwipeActionMeta
...
fun SwipeableActionsBox(
  ...
  backgroundUntilSwipeThreshold: Color = Appspiriment.colors.primary,
...
private fun ActionIconBox(
  ...
  Row(
    modifier = modifier
      ...
      .padding(horizontal = Appspiriment.sizes.paddingMedium),
